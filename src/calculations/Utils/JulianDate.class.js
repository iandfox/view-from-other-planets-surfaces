...
class JulianDate {
	...
	get epoch() {
		const daysSinceJD2000 = this.JD - 2451545;
		return moment('2000-01-01T12:00:00-00:00').add(daysSinceJD2000, 'days').unix();
	}
	...
	_fromEpoch(epoch) {
		// this.JD = Math.abs(moment.unix(epoch).diff(this.JD0_moment, 'days'));
		// return this.JD;
		// // Writing this all out in steps because for some reason it's bamboozling me.
		// const JD2000 = 2451545;
		// const JD2000_epoch = 946753200;
		// const seconds_since_JD2000 = epoch - JD2000_epoch;
		// const days_since_JD2000 = seconds_since_JD2000 / (60 * 60 * 24);
		// const JD = JD2000 + days_since_JD2000;
		// this.JD = JD;
		// return this.JD;
	}
	 ...
	 * @return {number} JD
	 */
	_fromDate(Y, M, D, H = 0, m = 0, s = 0, ms = 0) {
		// return this.fromEpoch(Date.UTC(Y, M - 1 /* 0-indexed */, D,H, m, s, ms));
		// H += this.UT_hours;
		//
	...
	get _epoch() {
		...
		// const JD2000 = this.JD2000;
		// const JD2000_epoch = 946753200;
		//
		// const JD = this.JD;
		// const days_since_JD2000 = JD - JD2000;
		// const seconds_since_JD2000 = days_since_JD2000 * 60 * 60 * 24;
		// const epoch = seconds_since_JD2000 + JD2000_epoch;
		// return epoch;
	}
